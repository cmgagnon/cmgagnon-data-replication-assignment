...
anova(glme1e,glme1d)
```
Model **glmer1c** seems to be a better fit which means maternal rank is not affecting the probablity of conceiving in females which were born in adverse conditions.
...
anova(glme2c,glme2b)
```
So it appears that model **glme2a** which does not include maternal rank is a better fit which means that maternal rank may not be a factor in the resumption of cycle of females which where born in poor conditions.
